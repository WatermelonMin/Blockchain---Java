...
public class InputPage implements ActionListener{
    private Container c;
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()== check){
            ...
            try {
                //System.out.println("Size before adding: " + DataIO.allMedicalStaff.size());
                String id = "MS-"+(DataIO.allMedicalStaff.size()+10001);
                JOptionPane.showMessageDialog(f, "You ID is "+id+"!");
                ...
                DataIO.allMedicalStaff.add(new MedicalStaff_General(id,a,encrypted,c,
                        d,g,h,j,k,m,n,secretKeyString));
                DataIO.writeToFile();
                f.setVisible(false);
    ...
    public void clearFields(){
        ...
        male.setSelected(true);
        female.setSelected(false); // Deselect female
